...
public class Employe {
    ...
    public Integer getNbRtt(LocalDate d){
        ...
        case THURSDAY: if(d.isLeapYear()) nbRttJours = nbRttJours + 1; break;
        case FRIDAY:
        if(d.isLeapYear()) nbRttJours = nbRttJours + 2;
        ...
        // Utilisation de nbRttJours
        return (int) Math.ceil((i1 - Entreprise.NB_JOURS_MAX_FORFAIT - nbRttJours - Entreprise.NB_CONGES_BASE - monInt) * tempsPartiel);
    }
